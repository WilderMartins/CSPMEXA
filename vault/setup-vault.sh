...
curl -s --header "X-Vault-Token: $VAULT_TOKEN" --request POST \
     --data '{"data": {"user": "cspmexa_user", "password": "a_very_secure_password_from_vault"}}' \
...
curl -s --header "X-Vault-Token: $VAULT_TOKEN" --request POST \
     --data '{"data": {"client_id": "COLOQUE_SEU_GOOGLE_CLIENT_ID_AQUI", "client_secret": "COLOQUE_SEU_GOOGLE_CLIENT_SECRET_AQUI"}}' \
